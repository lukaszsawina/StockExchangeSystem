...
namespace CurrencyExchangeLibrary.Controllers
{
    ...
    public class StockAPIController : ControllerBase
    {
        ...
        public StockAPIController(IStockRepository stockRepository, ILogger<StockAPIController> logger, IMapper mapper)
        {
        ...
        //Get
        [HttpGet]
        [ProducesResponseType(200, Type = typeof(IEnumerable<Models.OUTPUT.StockOutModelDto>))]
