...
$stock = $_GET['c'];
$api_url = 'https://localhost:7070/api/Stock/'.$stock ;
...
?>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded d-flex align-items-center p-4">
                            ...
                            <div class="ms-3">
                                <h1 class="text-body mb-2">Symbol: <?php echo $response->metaData->symbol;?></h1>
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="table-responsive">
                                <table id="dtDynamicVerticalScrollExample" class="table mb-2">
                                    ...
                                    <tbody id="tableBody">
                                        <?php
                                        foreach ($response->ohlcvData as &$c)
                                        {
                                            ...
                                            <td><?php echo number_format($c->low,2, ',', ' ');?></td>
                                            <td><?php echo number_format($c->close,2, ',', ' ');?></td>
                                        </tr>           
                                            <?php
                                        } 
                                        ?>                     
    ...
    var xValues = [];
    var chartType = false;
    var currentCrypto = "<?php echo $stock;?>";
